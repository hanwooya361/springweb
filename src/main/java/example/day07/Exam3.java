...
public class Exam3 {
    public static void main(String[] args) {
        ...
        // 2. 스트림API, 리스트객체.stream().중간연산1().중간연산2().최종연산();
            ...
            // 스트림이란? 컬렉션(리스트) 인스턴스를 흐름단위를 중간연산과 최종연산 제공 API(미리만든 클래스/메소드)
            // 메소드 래퍼런스 API: 미리 만들어진 메소드들을 간편하게 호출하는 방법 제공 API
            // System.out.print("메소드호출 정석"); --> (x) -> System.out::print;
